...
/***/ function(module, exports, __webpack_require__) {
	...
	window.onload = function () {
	    ...
	    tracker.on('track', function (event) {
	        ...
	        point.style.left = (canvas.width - rect.x) / canvas.width * 100 + "%";
	        point.style.top = rect.y / canvas.height * 100 + "%";
	        demoFlashlight.style.top = (rect.y - 250) / canvas.height * 100 + "%";
	        demoFlashlight.style.left = (canvas.width - rect.x - 250) / canvas.width * 100 + "%";
	        demoFlashlight.style.backgroundPosition = (canvas.width - rect.x) / canvas.width * 100 + "%" + rect.y / canvas.height * 100 + "%";
	...
	var demoFlashlight = document.getElementById('light');

	document.onmousemove = function (event) {
	    demoFlashlight.style.top = event.pageY - 250 + "px";
	    demoFlashlight.style.left = event.pageX - 250 + "px";
	};
